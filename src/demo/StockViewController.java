...
public class StockViewController {
	...
	@FXML
	private DatePicker stockRangerPicker;
	@FXML
	private ListView<String> stockRangeList;
	@FXML
	...
	@FXML
	private DatePicker stockRangerPicker1;
	@FXML
	...
	// Event Listener on DatePicker[#stockDayPicker].onInputMethodTextChanged
	@FXML
	public void findStock1(InputMethodEvent event) {
	...
	// Event Listener on DatePicker[#stockRangerPicker].onInputMethodTextChanged
	@FXML
	...
	// Event Listener on DatePicker[#stockRangerPicker1].onInputMethodTextChanged
	@FXML
